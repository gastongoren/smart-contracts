...
echo -e "${BLUE}🧪 Prueba de Validación de Firmantes Autorizados (JSON)${NC}"
echo "=========================================="
echo ""
...
# 3️⃣ Crear contrato CON requiredSigners usando POST /contracts
echo -e "${YELLOW}2️⃣ Creando contrato con firmantes requeridos (POST /contracts)...${NC}"
...
# 4️⃣ Verificar GET /contracts/mine
...
# 5️⃣ Intentar firmar con usuario autorizado
...
# 6️⃣ Intentar firmar con usuario NO autorizado (debe fallar)
...
# 7️⃣ Verificar detalles del contrato
